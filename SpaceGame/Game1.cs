...
namespace SpaceGame
{
    ...
    public class Main : Game
    {
        ...
        List<PowerUp> objects = new List<PowerUp>();
        ...
        private void TimeElapsed(object sender, EventArgs e)
        {
            try
            {
                objects.Add(new PowerUp(Content, pObjectType.Box, Rand.Next((int)Wall1.Position.Y + 30, (int)Wall4.Position.Y - 10)));
        ...
        {
            objects.Add(new PowerUp(Content, pObjectType.Asteroid, Rand.Next((int)Wall1.Position.Y + 10, (int)Wall4.Position.Y -10)));
            RandTimer.Stop();
            RandTimer.Interval = Rand.Next(1000, 2000);
            RandTimer.Start();
        }
